...
class Pagination {
    ...
    public function __construct($total, $currentPage, $limit, $sortBy, $order) {
        //Устанавливаем общее количество записей
        $this->total = $total;
        //Устанавливаем количество записей на страницу
        $this->limit = $limit;
        //Устанавливаем по какому полю будем сортировать
        $this->sortBy = $sortBy;
    ...
    private function generateHtml($page, $text = null) {
        ...
        return '<li class="page-item"><a class="page-link" href="' . $currentURI . $page . '/' . $this->sortBy . '/' . $this->order . '">' . $text . '</a></li>';
    }
